    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.content}>
                <Text style={styles.contentTitle}>Nyeri Dada Menjalar Punggung Leher Bahu dan Epigastrium</Text>

                <View>
                    <TouchableOpacity style={styles.yaButton} onPress={() => router.push('/test/test11')}>
