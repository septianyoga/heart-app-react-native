    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.content}>
                <Text style={styles.contentTitle}>Mempunyai Riwayat Keluhan Nyeri Dada Khas Angina</Text>

                <View>
                    <TouchableOpacity style={styles.yaButton} onPress={() => router.push('/test/test10')}>
